...
<link rel="stylesheet" type="text/css" href="/resources/css/second_category.css">
...
<div class="s-list">
    <c:forEach var="home" items="${list}" begin="6" step="1">
			<div class="s_imgT">
				<a href="/shoppingmall/product/product?p_num=${home.p_num }">
				<img src="/resources/images/<c:out value="${home.p_image}"/>" id="p_image" />
				</a>
				<div class="s-title">${home.p_name }</div>
				<div class="s-con">${home.p_content }</div>
				<div class="s-price">${home.p_price }</div>
			</div>
	</c:forEach>
</div>

...
<body>
	<div class="total">
		...
		<form method="get">
			<div class="row">
					<div class="col-md-8 "><button data-oper="wrig" type="button"  style=" background-color : black; color : white; width : 10%;">글쓰기</button></div>
					<div class="col-md-4 " style="text-align: right;">
						<input class="form-check-input" type="radio" value="title" name="option" checked="checked">제목
						<input class="form-check-input" type="radio" value="n_context" name="option">내용
					<input type="text" name="keyword"><button type="submit" data-oper="search" style=" background-color : black; color : white; width : 10%; margin-left: 1%;" >검색</button>
					</div>
			</div>
		</form>
				<table class="table" >
					...
					<tr>
						...
						<td>
							<a class="move" href='<c:out value="${notice.n_num}"/>' style="text-decoration: none; color:black;">   
								<c:out value="${notice.n_title }"></c:out>
							</a>
						</td>
						<td><c:out value="${notice.admin_id }"></c:out> </td>
						<td><fmt:formatDate value="${notice.n_regdate }"/></td>
					</tr>
